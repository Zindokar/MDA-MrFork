class SchedulesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @schedule.update(schedule_params)
        format.html { redirect_to [@restaurant, @schedule], notice: 'Schedule was successfully updated.' }
  ...
  def destroy
    @schedule.destroy
    respond_to do |format|
      format.html { redirect_to restaurant_schedules_path, notice: 'Schedule was successfully destroyed.' }
